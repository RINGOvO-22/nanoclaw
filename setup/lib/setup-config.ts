...
export const CONFIG: Entry[] = [
  ...
  },
  {
    ...
    help: 'Use an OpenAI API key instead of ChatGPT login.',
    surface: 'flag+ui',
    group: 'Codex',
    type: 'string',
    secret: true,
  ...
  },
  {
    ...
    help: 'Optional experimental API-compatible endpoint for Codex.',
    surface: 'flag+ui',
    group: 'Codex',
    type: 'url',
  ...
  },
  {
    ...
    flag: '--codex-model',
    label: 'Codex model',
    help: 'Optional model override for Codex-backed agents.',
    surface: 'flag+ui',
    group: 'Codex',
    type: 'string',
    validate: (v) => (v.trim() ? undefined : 'Required'),
